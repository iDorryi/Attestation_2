...
public class PrizeBox {
    ...
    public int dropPrize() {
        ...
        // первый выбор элементов случайный
        if (this.inside.size() == 0) {
            return -1;
        }
    ...
    public void FillBox() {
        ...
        for (int i = 0; i < 11; i++) {
            ...
            switch (randToy) {
                case 1:
                    this.inside.add(new MiniCar());
                    // car.downQuantity();
                    break;
                case 2:
                    this.inside.add(new Barby());
                    // doll.downQuantity();
                    break;

                case 3:
                    this.inside.add(new SuperHero());
